                                        ...
                                        @foreach ($posts as $key=>$post)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('admin.post.show', $post->id) }}" class="btn btn-sm btn-success"><i class="nav-icon fas fa-eye"></i></a>

                                                    <a href="{{ route('admin.post.edit', $post->id) }}" class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit"></i></a>
