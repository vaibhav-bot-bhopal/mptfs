                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-footer mb-1">
                                    ...
                                    <a href="{{route('admin.post.index')}}" class="btn btn-danger"><i class="nav-icon fas fa-arrow-circle-left" style="margin-right: 8px;"></i>BACK</a>
                                </div>
                                <!-- /.card-footer -->
                            </div>
                            <!-- /.card -->
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-footer mb-1">
                                    ...
                                    <a href="{{route('admin.post.index')}}" class="btn btn-danger"><i class="nav-icon fas fa-arrow-circle-left" style="margin-right: 8px;"></i>वापस</a>
                                </div>
                                <!-- /.card-footer -->
                            </div>
                            <!-- /.card -->
