                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 ">
                        ...
                        <div class="card card-info">
                            ...
                            <h3 class="card-title">Upload Your Posters <span id="counter"></span></h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body mt-2 mb-2">
                                <form method="POST" action="{{ url('user/posters-save') }}" enctype="multipart/form-data" class="dropzone" id="my-dropzone">
                                    @csrf
