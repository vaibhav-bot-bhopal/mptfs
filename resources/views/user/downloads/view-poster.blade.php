...
@section('title','View Downloads - MPTFS')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Poster Page</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 ">
                        ...
                        <div class="card card-info">
                            ...
                            <h3 class="card-title">View Your Posters</h3>
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    @forelse ($photos as $photo)
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="image-box">
                                                        <a href="{{asset('public/storage/downloads/'. $photo->filename)}}" data-toggle="lightbox" data-title="{{$photo->original_filename}}" data-gallery="gallery">
                                                            <img class="img-fluid pad rounded" src="{{asset('public/storage/downloads/'. $photo->filename)}}" alt="Gallery Image" style="height: 300px!important;">
                                                        </a>
                                                    </div>
                                                </div><!-- /.card-body -->
                                                ...
                                                <div class="card-footer d-flex">
                                                    ...
                                                    <form id="delete-form-{{ $photo->id }}" action="{{ route('user.posters-delete', $photo->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <h3 class="text-center" style="font-weight: 600;">No Posters Found !!</h3>
                                        </div>
                                        <!-- /.col -->
                                    @endforelse
                                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">पोस्टर पृष्ठ</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 ">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                            <h3 class="card-title">अपने पोस्टर देखें</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body mt-2 mb-2">
                                <!-- Gallery Section Start Here -->
                                <div class="row">
                                    @forelse ($photos as $photo)
                                        ...
                                        <div class="col-md-12">
                                            <h3 class="text-center" style="font-weight: 600;">कोई पोस्टर नहीं मिला !!</h3>
                                        </div>
                                        <!-- /.col -->
                                    @endforelse
                                </div>
        ...
        <div class="modal fade" id="delModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        क्या आप वास्तव में इस पोस्टर को मिटाना चाहते हैं ?
                    </div>
                    <div class="modal-footer">
