                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h3 class="card-title">
                                ...
                                <span class="badge badge-info pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip" data-placement="top" title="Total Number of Awareness Initiatives" style="font-size: 18px; font-weight: 500;">{{ $awareness->count() }}</span>
                            </h3>
                            <a class="btn btn-success ml-auto" href="{{ route('user.awareness.create') }}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>ADD AWARENESS INITIATIVE</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($awareness as $key=>$aware)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('public/storage/awareness-english/'.$aware->image) }}" alt="Feature-Image" width="200" height="140" class="rounded">
                                            </td>
                                            <td class="text-center">
                                                {{-- <a href="#" class="btn btn-sm btn-success"><i class="nav-icon fas fa-eye"></i></a> --}}

                                                <a href="{{ route('user.awareness.edit', $aware->id) }}" class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit"></i></a>

                                                <button type="button" class="btn btn-sm btn-danger" onclick="deleteAwareness({{ $aware->id }})"><i class="nav-icon fas fa-trash-alt"></i></button>
                                                <form id="delete-form-{{ $aware->id }}" action="{{ route('user.awareness.destroy', $aware->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h3 class="card-title">
                                ऑल अवेयरनेस लिस्ट
                                <span class="badge badge-info pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip" data-placement="top" title="अवेयरनेस की कुल संख्या" style="font-size: 18px; font-weight: 500;">{{ $awareness->count() }}</span>
                            </h3>
                            <a class="btn btn-success ml-auto" href="{{ route('user.awareness.create') }}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>नया अवेयरनेस जोड़ें</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                            <table id="tblPost" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($awareness as $key=>$aware)
                                        <tr>
                                            ...
                                            <td>{!! Str::limit($aware->discription, '150') !!}</td>
                                            <td>
                                                <img src="{{ asset('public/storage/awareness-hindi/'.$aware->image) }}" alt="Feature-Image" width="200" height="140" class="rounded">
                                            </td>
                                            <td class="text-center">
                                                {{-- <a href="#" class="btn btn-sm btn-success"><i class="nav-icon fas fa-eye"></i></a> --}}
