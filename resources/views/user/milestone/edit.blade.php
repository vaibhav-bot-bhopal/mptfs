...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- form start -->
            <form action="{{route('user.milestone.update', $milestone->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                @method('PUT')
                <div class="row">
                    <!-- right column -->
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body pb-2 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{($errors->any() && $errors->first('title')) ? 'is-invalid' : ''}}" id="title" name="title" value="{{ $milestone->title }}" placeholder="Enter Event Title Here">
                                    @if ($errors->any())
                                ...
                                <textarea class="ckeditor form-control {{($errors->any() && $errors->first('pbody')) ? 'is-invalid' : ''}}" id="pbody" name="pbody">{{ $milestone->description }}</textarea>
                                    @if ($errors->any())
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" id="himage" name="himage" value="{{$milestone->image}}">
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" id="hmimage" name="hmimage" value="{{$milestone->images}}">
                                </div>

                                <div class="form-group">
                                    <label for="inputmImage">Milstone Images</label>
