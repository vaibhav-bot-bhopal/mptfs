...
@if (session('locale') == 'en')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <!-- form start -->
                <form action="{{route('author.post.update', $post->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <!-- right column -->
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body pb-2 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{($errors->any() && $errors->first('title')) ? 'is-invalid' : ''}}" id="title" name="title" value="{{ $post->title }}" placeholder="Enter Post Title Here">
                                        @if ($errors->any())
                                    ...
                                    <div class="form-group row pt-3">
                                        ...
                                        <div class="icheck-success d-inline">
                                            <input type="checkbox" id="publish" name="status" value="1" {{ $post->status == true ? 'checked' : '' }}>
                                            <label for="publish">
                                                Publish
                                            </label>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-footer mb-1">
                                    <button type="submit" class="btn btn-success float-right"><i class="nav-icon fas fa-upload" style="margin-right: 8px;"></i>PUBLISH</button>
                                    <a href="{{route('author.post.index')}}" class="btn btn-danger"><i class="nav-icon fas fa-arrow-circle-left" style="margin-right: 8px;"></i>BACK</a>
                                </div>
                                <!-- /.card-footer -->
                            </div>
                            <!-- /.card -->
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea class="ckeditor form-control {{($errors->any() && $errors->first('pbody')) ? 'is-invalid' : ''}}" id="pbody" name="pbody">{{ $post->body }}</textarea>
                                        @if ($errors->any())
                    ...
                    <div class="row">
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-body pb-2 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{($errors->any() && $errors->first('title')) ? 'is-invalid' : ''}}" id="title" name="title" value="{{ $post->title }}" placeholder="यहां पोस्ट शीर्षक दर्ज करें">
                                        @if ($errors->any())
                                            <p class="text-danger">{{$errors->first('title')}}</p>
                                        @endif
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- /.card-body -->
                                <div class="card-footer mb-1">
                                    <button type="submit" class="btn btn-success float-right"><i class="nav-icon fas fa-upload" style="margin-right: 8px;"></i>पब्लिश</button>
                                    <a href="{{route('author.post.index')}}" class="btn btn-danger"><i class="nav-icon fas fa-arrow-circle-left" style="margin-right: 8px;"></i>वापस</a>
                                </div>
                                <!-- /.card-footer -->
                            </div>
                            <!-- /.card -->
