                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h3 class="card-title">
                                ALL POST LIST
                                <span class="badge badge-info  pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip" data-placement="top" title="Total Number of Posts" style="font-size: 18px; font-weight: 500;">{{ $posts->count() }}</span>
                                </h3>
                                <a class="btn btn-success ml-auto" href="{{route('author.post.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>ADD NEW POST</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    @foreach ($posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('author.post.show', $post->id) }}" class="btn btn-sm btn-success"><i class="nav-icon fas fa-eye"></i></a>

                                                <a href="{{ route('author.post.edit', $post->id) }}" class="btn btn-sm btn-info"><i class="nav-icon fas fa-edit"></i></a>

                                                <button type="button" class="btn btn-sm btn-danger" onclick="deletePost({{ $post->id }})"><i class="nav-icon fas fa-trash-alt"></i></button>
    ...
    @if (session('locale') == 'hi')
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                    <h1 class="m-0">पोस्ट पेज</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">मुख्य पेज</a></li>
                            <li class="breadcrumb-item active">पोस्ट</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                <h3 class="card-title">
                                    ऑल पोस्ट लिस्ट
                                <span class="badge badge-info  pt-1 pb-1 pl-2 pr-2 ml-1" data-toggle="tooltip" data-placement="top" title="पोस्ट की कुल संख्या" style="font-size: 18px; font-weight: 500;">{{ $posts->count() }}</span>
                                </h3>
                                <a class="btn btn-success ml-auto" href="{{route('author.post.create')}}"><i class="nav-icon fas fa-plus-circle" style="margin-right: 5px;"></i>नई पोस्ट जोड़ें</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="tblPost" class="table table-bordered table-striped">
